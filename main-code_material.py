...
data_path = "images/train-material/"
...
# label list
classes = np.unique(products['Material'])
train_classes = np.unique(train_products['Material'])
valid_classes = np.unique(valid_products['Material'])
...
# it in the code 
classifier_saved = 'models/model_Adamax_material.pth'
...
def test():
    ...
    for i in range(1,5):
        print("article: ", i)
        img_path = 'images/test-material/test_' + str(i) + '.jpg'
        # print(img_path)
        # loading model
        cnn = CNN()
